...
; cache dir : %userhome%/My Documents/ActiveGSLocalData

imageDir  := %0%
;imageDir  := "\\NAS\emul\image\Apple2gs\adventure\Police Quest (1987)(Sierra)"
;imageDir   := "\\NAS\emul\image\Apple2gs\adventure\King's Quest (1987)(Sierra)"
;imageDir   := "\\NAS\emul\image\Apple2gs\rpg\Dragon Wars (1990)(Interplay)"
;imageDir   := "\\NAS\emul\image\Apple2gs\rpg\Dragon Wars (1990)(Interplay)\Dragon Wars (1990)(Interplay)(DIsk1).hdd.zip"
;imageDir   := "\\NAS\emul\image\Apple2gs\temp\Downhill Challenge (1989)(Broderbund)"

fddContainer := new DiskContainer( imageDir, "i)^(?!.*?(2mg|dsk|woz)$" )
...
{
	Run, % "ActiveGS.exe " wrap(A_ScriptDir "\run.activegsxml"),,,emulatorPid
...
setConfig(imageDir) {
  ...
  ;x.viewXML()
  x.save( A_ScriptDir "\run.activegsxml" )
