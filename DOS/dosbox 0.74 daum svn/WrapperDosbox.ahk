...
setConfig( imageFilePath, cdContainer, windowsVersion ) {
	...
	if ( windowsVersion == "win3kr") {
		...
		dosboxConfText := dosboxConfText "copy W:\WINDOWS\��������.GRP.bak W:\WINDOWS\��������.GRP`n"
		dosboxConfText := dosboxConfText "copy W:\WINDOWS\IMEINFO.INI.bak W:\WINDOWS\IMEINFO.INI`n"
		
		dosboxConfText := dosboxConfText "copy c:\_EL_CO~1\os\win3\��������.GRP W:\WINDOWS\`n"
		...
		dosboxConfText := dosboxConfText "copy W:\WINDOWS\��������.GRP c:\_EL_CO~1\os\win3`n"
