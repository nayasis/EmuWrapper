...
imageFilePath  := %0%
;imageFilePath  := ""
; imageFilePath  := "\\NAS\emul\image\MSX\MSX1 Various\Boulder Dash (1985)"
; imageFilePath  := "\\NAS\emul\image\MSX\MSX1 Various\Demonia (1986)(Microids)"
...
if( option != false ) {
	...
	; commandLine := "openmsx.exe -machine C-BIOS_MSX1_JP -control stdio" option
	; commandLine := "openmsx.exe -machine Sony_HB-55P -control stdio" option
	commandLine := "openmsx.exe -machine Boosted_MSX1 -control stdio" option
	; commandLine := "openmsx.exe -machine Toshiba_HX-10 -ext Sony_HBD-F1 -control stdio" option
