...
emulatorPid    := ""
imageFilePath  := %0%
; imageFilePath  := "\\NAS\emul\image\MSX\MSX2 Various\Cosmic Soldier (1985)(Kogado - Ascii)"
...
if( option != false ) {
	...
	; commandLine := "openmsx.exe -machine Sony_HB-F1XV -control stdio" option
	; commandLine := "openmsx.exe -machine Daewoo_DPC-200 -control stdio" option
