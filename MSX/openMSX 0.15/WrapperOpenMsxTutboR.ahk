...
emulatorPid    := ""
imageFilePath  := %0%
imageFilePath  := "\\NAS\emul\image\MSX\MSX2 Various\Zanac Ex (en)"
...
if( option != false ) {
	...
	; commandLine := "openmsx.exe -machine C-BIOS_MSX2 -control stdio" option
	...
	; sendCommand( "set renderer SDLGL-PP" )
