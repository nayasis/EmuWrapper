...
debug( "JoystickNumber : " JoystickNumber )
...
debug( "joy_buttons : " joy_buttons )
debug( "joy_name : " joy_name )
debug( "joy_info : " joy_info )
Loop
{
	buttons_down =
	Loop, %joy_buttons%
	...
	IfInString, joy_info, D
	{
		GetKeyState, JoyD, %JoystickNumber%JoyD
		; debug( JoyD )
		axis_info = %axis_info%%A_Space%%A_Space%V%JoyD%
	}
